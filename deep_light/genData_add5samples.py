...
def normalize_data(X, input_dim, output_dim):
    ...
    #maxs = [229, 114, 70, 125, 950, 660, 6.5, 14, 14]
    while i <= -1:
        x_min = mins[i]
        x_max = maxs[i]
        ...
        if sky_map:
            ...
            with open("data/processed_data/" + type + "min_max_normalization.txt", "w") as myfile:
                myfile.write('This information is for restore normalization purpose:'
                             ...
                             'Sample 1 min=%.5f, Sample 1 max=%.5f, '
                             'Sample 2 min=%.5f, Sample 2 max=%.5f, '
                             'Sample 3 min=%.5f, Sample 3 max=%.5f, '
                             'Sample 4 min=%.5f, Sample 4 max=%.5f, '
                             'Sample 5 min=%.5f, Sample 5 max=%.5f, '
                             ...
                             % (mins[0], maxs[0], mins[1], maxs[1], mins[2], maxs[2], mins[3], maxs[3],
                                ...
                                mins[8], maxs[8], mins[9], maxs[9], mins[10], maxs[10], mins[11], maxs[11],
                                mins[12], maxs[12], mins[13], maxs[13], mins[14], maxs[14]))
                myfile.close()
        else:
            # save full normalization information to txt files
            with open("data/processed_data/" + type + "min_max_normalization.txt", "w") as myfile:
                myfile.write('This information is for restore normalization purpose:'
                             ...
                             % (mins[0], maxs[0], mins[1], maxs[1], mins[2], maxs[2], mins[3], maxs[3],
                                mins[4], maxs[4], mins[5], maxs[5], mins[6], maxs[6], mins[7], maxs[7],
                                mins[8], maxs[8], mins[9], maxs[9], mins[10], maxs[10], mins[11], maxs[11],
                                mins[12], maxs[12], mins[13], maxs[13]))
                myfile.close()
